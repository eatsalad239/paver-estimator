...
export default function ResultStep({ config, service, areaLabel, sqft, conditionLabel, estimate, requiresConsult, onRestart }) {
  const serviceLabel = config.services.find((s) => s.id === service)?.label ?? service;
